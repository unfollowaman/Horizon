...
// Wrap SyllabusTopicNode in React.memo to prevent unnecessary re-renders of individual
// topic nodes when parent accordion state or sibling components update in list views
// like SyllabusHierarchyTree.
