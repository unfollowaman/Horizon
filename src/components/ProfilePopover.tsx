      ...
      {isOpen && (
        <div className={`${styles.popoverMenu} neu-raised`}>
          ...
          <div className={styles.popoverActions}>
            <Link
              to="/dashboard"
              className={`${styles.popoverLink} focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/20`}
            ...
            <button
              ...
              className={`${styles.popoverSignOutBtn} focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/30`}
            >
              Sign Out
            </button>
          </div>
