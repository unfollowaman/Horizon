...
const PdfViewerSkeleton: React.FC<PdfViewerSkeletonProps> = ({ title }) => {
  return (
    <div className="fixed inset-0 w-full h-full bg-[var(--bg-base)] flex flex-col overflow-hidden z-50" aria-hidden="true">
      {/* Top Controls Bar Loading State */}
      ...
      {/* Main Document Loading Area */}
      <div className="flex-1 w-full p-4 md:p-8 flex items-center justify-center overflow-hidden relative">
        <div className="neu-card w-full max-w-[800px] h-[calc(100vh-8rem)] rounded-2xl p-6 flex flex-col items-center justify-center relative">
