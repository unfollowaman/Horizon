...
- **Class 8 English Grammar Representation:** Removed attached grammar topics from literature chapters 1–8. Created dedicated Chapter 17 `English Grammar Syllabus` containing all 9 official grammar topics individually with `topic_type = 'grammar'`.
- **Class 8 Hindi Grammar Representation:** Created dedicated Chapter 14 `हिंदी व्याकरण (वसंत भाग–3)` containing all 10 official grammar subtopics from the PDF individually with `topic_type = 'grammar'`.
- **Class 8 Sanskrit Grammar Representation:** Created dedicated Chapter 15 `संस्कृत व्याकरणम् (रुचिरा भाग–3)` containing all 8 official grammar subtopics from the PDF individually with `topic_type = 'grammar'`.
...
- **Class 10 English Grammar Representation:** Structured Chapter 19 `English Grammar Syllabus` containing all 7 official individual grammar topics from the PDF with `topic_type = 'grammar'`.
- **Class 10 Sanskrit Grammar Representation:** Structured Chapter 11 `संस्कृत व्याकरणम् (शेमुषी भाग–2)` containing all 7 official individual grammar topics from the PDF with `topic_type = 'grammar'`.
